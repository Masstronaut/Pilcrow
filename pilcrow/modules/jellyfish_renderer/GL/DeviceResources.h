...
public:
  ...
  DeviceResources(DXGI_FORMAT backBufferFormat  = DXGI_FORMAT_B8G8R8A8_UNORM,
                  ...
                  unsigned int      flags           = c_AllowTearing);
  ~DeviceResources();
  ...
  void StoreResource(Microsoft::WRL::ComPtr<ID3D12Resource> &resource) {
    m_frameResources[m_backBufferIndex].push_back(resource);
  }
...
private:
  ...
  Microsoft::WRL::ComPtr<ID3D12CommandAllocator>
    m_commandAllocators[MAX_BACK_BUFFER_COUNT];
  std::vector<Microsoft::WRL::ComPtr<ID3D12Resource>>
    m_frameResources[MAX_BACK_BUFFER_COUNT];
